...
Some global element-ui style modifications can be set in [@/src/styles/element-ui.scss](https://github.com/tuandm/laravue/blob/master/resources/js/styles/element-ui.scss).
...
Code: [@/src/components/ThemePicker](https://github.com/tuandm/laravue/blob/master/resources/js/components/ThemePicker/index.vue)。
